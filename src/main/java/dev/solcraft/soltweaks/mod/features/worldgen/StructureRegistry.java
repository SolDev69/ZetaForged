package dev.solcraft.soltweaks.mod.features.worldgen;
...
import dev.solcraft.soltweaks.mod.features.worldgen.features.ConcernSpire;

import static dev.solcraft.soltweaks.mod.SolTweaks.MOD_ID;
...
public class StructureRegistry implements ModInitializer {
    ...
    public static final ConfiguredFeature<?, ?> CONCERN_SPIRE = SPIRE.configure(new ConcernSpire.SpiralFeatureConfig(ConstantIntProvider.create(15), new SimpleBlockStateProvider(SolTweaks.CONCERN_BLOCK.getDefaultState())))
