...
import dev.solcraft.soltweaks.mod.features.materials.KeystoneToolMaterial;
import dev.solcraft.soltweaks.mod.features.items.tools.wideners.AxeItem;
import dev.solcraft.soltweaks.mod.features.items.tools.wideners.PickaxeItem;
import dev.solcraft.soltweaks.mod.features.items.tools.wideners.TillerItem;

import static dev.solcraft.soltweaks.mod.features.items.RegisterVoidItems.keystoneTool;
