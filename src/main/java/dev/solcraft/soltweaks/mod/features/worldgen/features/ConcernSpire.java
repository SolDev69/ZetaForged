package dev.solcraft.soltweaks.mod.features.worldgen.features;
...
public class ConcernSpire extends Feature<ConcernSpire.SpiralFeatureConfig> {
    public ConcernSpire(Codec<ConcernSpire.SpiralFeatureConfig> configCodec) {
        super(configCodec);
    }
