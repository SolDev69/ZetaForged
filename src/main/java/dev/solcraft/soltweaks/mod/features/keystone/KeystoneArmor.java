...
import dev.solcraft.soltweaks.mod.features.materials.KeystoneArmorMaterial;
...
public class KeystoneArmor {
    ...
    public static void register() {
        //Registry.register(Registry.ITEM, new Identifier(SolTweaks.MOD_ID, KEYSTONE"), KEYSTONE);
