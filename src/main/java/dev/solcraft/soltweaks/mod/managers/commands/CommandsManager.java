package dev.solcraft.soltweaks.mod.managers.commands;
...
import dev.solcraft.soltweaks.mod.managers.GeneralManager;
//Static imports
...
// argument("bar", word())
// Import everything
import static dev.solcraft.soltweaks.mod.SolTweaks.ZFVersionString;
import static dev.solcraft.soltweaks.mod.managers.GeneralManager.getConfig;

@SuppressWarnings("ALL")
public class CommandsManager {
//    public static String version1 =
//            "SolTweaks version " + SolTweaks.MOD_VERSION +
//                    SPACE + "build" + SPACE + MOD_DEV_V + SPACE + SolTweaks.PHASE +
//                    "\n" +
...
//        }));
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) -> {
             ...
             * /soltweaks
             */
            dispatcher.register(literal("soltweaks").then(literal("version").executes(
                    context -> {
                        context.getSource().sendFeedback(new LiteralText(
                                "[SolTweaks] " + ZFVersionString
                        ),true);
//                        context.getSource().sendFeedback(new LiteralText(
//                                "[Zeta's API] SolTweaks API 1.0.0-alpha.2"
//                        ),true);
                        context.getSource().sendFeedback(new LiteralText(
