package dev.solcraft.soltweaks.features.biomes;
...
import static dev.solcraft.soltweaks.SolTweaks.GIGACONCERN_BLOCK;
...
public class ConcerningBiome {
    ...
    private static final ConfiguredSurfaceBuilder<TernarySurfaceConfig> CONCERNING_SURFACE_BUILDER = SurfaceBuilder.DEFAULT
            .withConfig(new TernarySurfaceConfig(
                    SolTweaks.CONCERN_BLOCK.getDefaultState(),
                    SolTweaks.HYPERCONCERN_BLOCK.getDefaultState(),
    ...
    private static final String MOD_ID = SolTweaks.MOD_ID;
    ...
    public static void register() {
        SolTweaks.log(Level.INFO, "Adding biomes");
    ...
    public static double conc = SolTweaks.concerning_weight;
