package dev.solcraft.soltweaks;
...
import dev.solcraft.soltweaks.features.biomes.BiomesInitializer;
import dev.solcraft.soltweaks.features.blocks.NegativeSlipperinessBlock;
import dev.solcraft.soltweaks.features.items.SuperFireballItem;
import dev.solcraft.soltweaks.managers.commands.CommandsManager;
import dev.solcraft.soltweaks.features.errors.compute.ComputeErrorFunction;
import dev.solcraft.soltweaks.features.items.ConcernedTater;
...
public class SolTweaks implements ModInitializer {
	...
	//public static final Item EXAMPLE_ITEM = Registry.register(Registry.ITEM,new Identifier("mymodid","example_item"), new Item(new FabricItemSettings().group(dev.solcraft.soltweaks.SolTweaks.SOLTWEAKS_ITEMS)));
